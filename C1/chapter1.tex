...
\subsection{Reading order}\label{sec:roadmap-order}

Chapters are intended to be read in sequence; the appendix can be consulted as needed. This subsection illustrates \verb|\subsection| (and optional italic style with class option \texttt{italic}).
