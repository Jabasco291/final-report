...
\subsection{Node Counts}\label{sec:node-counts}
...
\subsection{Room}\label{sec:rooms}
...
\textbf{Method} & \multicolumn{3}{c|}{\textbf{Drift (m)}} & \multicolumn{3}{c}{\textbf{MED (m)}} \\
 & Avg & Std & CV & Avg & Std & CV \\
\midrule
S-Graphs+ & \textbf{0.05} & 0.01 & 0.20 & \textbf{0.12} & 0.02 & 0.16 \\
Hydra     & 0.16 & 0.72 & 4.50 & 0.71 & 0.69 & 0.97 \\
