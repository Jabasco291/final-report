...
\multirow{4}{*}{\textbf{Objects}}
    ...
    & Per Run Object Drift               & Assesses object localisation consistency \\
...
The simulation phase concluded that Hydra was the best-performing method as an all round system (discussed in Section \ref{sec:discussion}). Therefore, this meant 3D LiDAR data wasn’t required for the real-world deployment due to S-Graphs+ being excluded from this stage.

The ZED camera was the optimal choice for recording the scene due to its simple setup and RGB-D capabilities alongside pose estimates. To mimic the perspective of a traversal robot like Reachy2, The camera was handheld at torso height (approx. 1.2m) whilst being walked slowly around the HCCR lab.
