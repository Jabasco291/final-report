...
\maketitle{%
  ...
  Hydra performed well at identifying objects, with a 79\% recall rate, but struggled to 
  segment all rooms in the scene with an 30\% recall rate, especially struggling with smaller rooms like bathrooms. Clio excelled at 
