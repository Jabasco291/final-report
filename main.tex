...
\maketitle{%
  ...
  \gls{slam}Simultaneous Localisation and Mapping (SLAM) is the fundamental robotics 
  ...
  This project focuses on deploying and evaluating 3 state of the art \gls{dsg} methods in a 
