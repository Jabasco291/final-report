...
This chapter reflects on the critical challenges and turning points encountered during the project, what lessons were learnt and how they were reapplied to improve the project. Concluding with discussing the skills I will take forward into future work.
...
During initial Clio deployment, I used a ROS1 Noetic container which I installed from \cite{shakeri2023docker}. A problem was encountered during Clio installation which kept preventing the Clio workspace from building. 
