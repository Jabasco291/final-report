...
The free-space clustering algorithm \ref{fig:free-space-alg}, divides the free-space graphs into several clusters corresponding to rooms. The algorithm has 3 main steps:
