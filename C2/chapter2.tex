...
\section{High-Level Method Comparison}\label{sec:method-comparison}

\begin{table}[H]
\centering
\caption{High-Level Method Comparison}
\begin{tabular}{c c p{3.5cm} c c c} % 4 columns, all left-aligned
\toprule
\textbf{Method} & \textbf{Layers No.} & \textbf{Layer Names} & \textbf{Data Approach} & \textbf{Structural?} & \textbf{Semantics?} \\ 
\midrule
\textbf{S-Graphs+}   & 4          & Keyframes, Walls, Rooms, Floors          & Geometric & Yes & No         \\
\textbf{Hydra}   & 5       & Metric-Semantic 3D Mesh, Objects and Agents, Places, Rooms, Buildings & Spatial & Yes & Yes        \\
\textbf{Clio}   & 5       & 3D Mesh, Objects and Agents, Places, Rooms, Buildings  & Task-Driven & Yes & Yes        \\
\bottomrule
\end{tabular}
\end{table}
